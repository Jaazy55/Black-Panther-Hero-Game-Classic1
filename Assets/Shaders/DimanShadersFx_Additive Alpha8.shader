Shader "DimanShadersFx/Additive Alpha8"
{
  Properties
  {
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          OUT_Data_Frag out_f;
          float4 tmpvar_1;
          float _tmp_dvx_20 = (((2 * in_f.xlv_COLOR) * _TintColor) * ((tex2D(_MainTex, in_f.xlv_TEXCOORD0).w * in_f.xlv_COLOR.w) * 2));
          tmpvar_1 = float4(_tmp_dvx_20, _tmp_dvx_20, _tmp_dvx_20, _tmp_dvx_20);
