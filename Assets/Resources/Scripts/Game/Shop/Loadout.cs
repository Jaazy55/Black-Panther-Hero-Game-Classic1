...
namespace Game.Shop
{
	...
	public class Loadout
	{
		public List<int> AllValues
		{
			get
			{
				List<int> list = this.Skin.Values.ToList<int>();
				list.AddRange(this.Weapons.Values.ToList<int>());
				return list;
			}
		}
		...
		{
			return Loadout.WeaponsKeyPrefix + slotIndex;
		}

		public static int WeaponSlotFromKey(string key)
		{
			return Convert.ToInt32(key.Substring(Loadout.WeaponsKeyPrefix.Length), 10);
		}
