...
namespace UnityEngine.AI
{
	...
	public class NavMeshSurface : MonoBehaviour
	{
		...
		public NavMeshBuildSettings GetBuildSettings()
		{
			...
			{
				UnityEngine.Debug.LogWarning("No build settings for agent type ID " + this.agentTypeID, this);
		...
		private static void Register(NavMeshSurface surface)
		{
			if (NavMeshSurface.s_NavMeshSurfaces.Count == 0)
			{
				...
				if (NavMeshSurface._003C_003Ef__mg_0024cache0 == null)
				{
					NavMeshSurface._003C_003Ef__mg_0024cache0 = new NavMesh.OnNavMeshPreUpdate(NavMeshSurface.UpdateActive);
				}
				NavMesh.onPreUpdate = (NavMesh.OnNavMeshPreUpdate)Delegate.Combine(onPreUpdate, NavMeshSurface._003C_003Ef__mg_0024cache0);
			}
		...
		private static void Unregister(NavMeshSurface surface)
		{
			...
			{
				Delegate onPreUpdate = NavMesh.onPreUpdate;
				if (NavMeshSurface._003C_003Ef__mg_0024cache1 == null)
				{
					NavMeshSurface._003C_003Ef__mg_0024cache1 = new NavMesh.OnNavMeshPreUpdate(NavMeshSurface.UpdateActive);
				}
				NavMesh.onPreUpdate = (NavMesh.OnNavMeshPreUpdate)Delegate.Remove(onPreUpdate, NavMeshSurface._003C_003Ef__mg_0024cache1);
			}
		}
		...
		[CompilerGenerated]
		private static NavMesh.OnNavMeshPreUpdate _003C_003Ef__mg_0024cache0;

		[CompilerGenerated]
		private static NavMesh.OnNavMeshPreUpdate _003C_003Ef__mg_0024cache1;
	}
}
