...
{
	[CreateAssetMenu(fileName = "SurvivalHitEntityModifier", menuName = "NPC/Create Survival Hit Entity Modifier", order = 2)]
	public class SurvivalHitEntityModifier : HitEntityModifier
	{
		...
		public float ModifyHealth
		{
			get
			{
				float num = SurvivalTimer.CurrentTime / 60f;
				if (num < 0f)
				{
					return 1f;
				}
