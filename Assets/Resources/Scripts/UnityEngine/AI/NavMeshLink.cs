	...
	public class NavMeshLink : MonoBehaviour
	{
		...
		private static void AddTracking(NavMeshLink link)
		{
			if (NavMeshLink.s_Tracked.Count == 0)
			{
				...
				if (NavMeshLink._003C_003Ef__mg_0024cache0 == null)
				{
					NavMeshLink._003C_003Ef__mg_0024cache0 = new NavMesh.OnNavMeshPreUpdate(NavMeshLink.UpdateTrackedInstances);
				}
				NavMesh.onPreUpdate = (NavMesh.OnNavMeshPreUpdate)Delegate.Combine(onPreUpdate, NavMeshLink._003C_003Ef__mg_0024cache0);
			}
		...
		private static void RemoveTracking(NavMeshLink link)
		{
			...
			{
				Delegate onPreUpdate = NavMesh.onPreUpdate;
				if (NavMeshLink._003C_003Ef__mg_0024cache1 == null)
				{
					NavMeshLink._003C_003Ef__mg_0024cache1 = new NavMesh.OnNavMeshPreUpdate(NavMeshLink.UpdateTrackedInstances);
				}
				NavMesh.onPreUpdate = (NavMesh.OnNavMeshPreUpdate)Delegate.Remove(onPreUpdate, NavMeshLink._003C_003Ef__mg_0024cache1);
			}
		}
