Shader "DimanShadersFx/Additive"
{
  Properties
  {
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          prev_3.xyz = float3((prev_3.xyz * (tmpvar_8.xyz * in_f.xlv_COLOR.xyz)));
          tmpvar_1 = prev_3;
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          col_1.xyz = (col_1 * col_1.w).xyz.xyz;
          col_1.w = col_1.w;
          out_f.color = col_1;
          return out_f;
      }
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          col_1.xyz = (tmpvar_2 * tmpvar_2.w).xyz.xyz;
          col_1.w = tmpvar_2.w;
          out_f.color = col_1;
          return out_f;
      }
